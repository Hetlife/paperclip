...
**Phase 1 — Free intelligence. In progress.**
...
| Next action | **Task 1.3 (co-founder — vet 3+ Gujarat suppliers)** is now the only unstarted Phase 1 item. 1.1, 1.2, 1.4 are in progress and can continue. |
...
3. **Gujarat is not a recognized export hub.** ~90% of India's
   ornamental fish exports move through Kolkata; Gujarat doesn't appear
   in available trade-hub data. This may mean the supply side has a
   logistics problem the brief didn't anticipate — ask every supplier in
   Phase 1.3 how they actually route exports. See
   `verification-queue.md` V14.
